...
export const handleChanges = async (e,state, setState,setFieldValue) =>{
      ...
      case 'zipcode_id':
        ...
        if(value.length== 5 || value.length==6){   
            ...
            if(zcode && zcode.length > 0){
                ...
                setFieldValue('ampher_id',arrAMPHUR[0].AMPHUR_ID);
                setFieldValue('province_id',arrPROVI[0].PROVINCE_ID) 
                setFieldValue('district_id',arrDIS[0].PROVINCE_ID) 
                setState({
                    ...state,
                    [name]:value,
